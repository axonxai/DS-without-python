...
func main() {
	imgs, err := readImageFile(os.Open("../data/mnist/train-images-idx3-ubyte"))
	if err != nil {
		log.Fatal(err)
	}
	labels, err := readLabelFile(os.Open("../data/mnist/train-labels-idx1-ubyte"))
	if err != nil {
		log.Fatal(err)
	}
	...
	testImgs, err := readImageFile(os.Open("../data/mnist/t10k-images-idx3-ubyte"))
	if err != nil {
		log.Fatal(err)
	}

	testlabels, err := readLabelFile(os.Open("../data/mnist/t10k-labels-idx1-ubyte"))
	if err != nil {
		log.Fatal(err)
	}
